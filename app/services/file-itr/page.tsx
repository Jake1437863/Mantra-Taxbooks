    ...
    <div style={{ minHeight: '100vh', background: '#070B14', color: '#F1F5F9', fontFamily: "'Outfit', 'Inter', system-ui, sans-serif" }}>
      ...
      <section style={{ position: 'relative', overflow: 'hidden', width: '100%', height: 'calc(100vh - 72px)', minHeight: 660, maxHeight: 880, display: 'flex', alignItems: 'center', background: '#070B14', padding: '40px 28px', borderBottom: '1px solid rgba(255, 255, 255, 0.08)' }}>
        <video
          ...
          muted
          playsInline
          style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover', opacity: 0.8, zIndex: 0, pointerEvents: 'none' }}
        >
          <source src="/hero-bg.mp4" type="video/mp4" />
        </video>
        <div style={{ position: 'absolute', inset: 0, background: 'linear-gradient(180deg, rgba(10, 30, 75, 0.3) 0%, rgba(7, 11, 20, 0.55) 100%)', zIndex: 1, pointerEvents: 'none' }} />
